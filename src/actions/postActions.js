import { GET_USER_WITH_POSTS, ADD_USER_POSTS, DELETE_USER_POST, EDIT_USER_POST, GET_USERS_POSTS } from './actionTypes';
import { DELETE, POST, PATCH, getUsersPostsPath } from '../constants';
...
export const getUsersPosts = data => ({ type: `${GET_USERS_POSTS}`, url: getUsersPostsPath, data, method: POST });
